...
public class GlobalException {
	...
	public ResponseEntity<MyErrorDetails> tutorialExceptionHandler(TutorialException te, WebRequest req){
	...
	public ResponseEntity<MyErrorDetails> commentExceptionHandler(CommentException exception, WebRequest req){
